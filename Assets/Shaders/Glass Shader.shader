...
Shader "Custom/Glass Shader"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_BaseColor("Base Color", Color) = (0.7647059,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 specularFinalColor42_g1 = ( AttenuationColor8_g1 * pow( max( dotResult32_g1 , 0.0 ) , SpecularPower14_g1 ) * 1.0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = max( float4( ( DiffuseColor70_g1 + specularFinalColor42_g1 ) , 0.0 ) , ( _BaseColor * float4( 0.1320755,0.1320755,0.1320755,0 ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18912
232;107;1184;552;1067.029;518.3618;1.815721;True;True
Node;AmplifyShaderEditor.SimpleMaxOpNode;21;-59.3037,146.1921;Inherit;True;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-404.2906,200.6638;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0.1320755,0.1320755,0.1320755,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;5;-579.4583,-105.1698;Inherit;False;Property;_BaseColor;Base Color;0;0;Create;True;0;0;0;False;0;False;0.7647059,1,1,1;0.6155216,0.9811321,0.9612036,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;11;-322.5832,-109.8245;Inherit;True;BlinnPhongLightWrap;-1;;1;139fed909c1bc1a42a96c42d8cf09006;0;5;1;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;2;FLOAT;1;False;3;FLOAT;0;False;44;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=BC297720D825D172E48943F6CC91E28371708711